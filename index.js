...
function sortPricing(hotel1, hotel2) {
  let pricing;
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let result = hotelsCopy.sort(sortPricing);
  res.json({ hotels: result });
});
function sortRating(hotel1, hotel2) {
  let rating;
...
app.get('/hotels/sort/rating', (req, res) => {
  let hotelsCopy = hotels.slice();
  let result = hotelsCopy.sort(sortRating);
  res.json({ hotels: result });
});
function sortReview(hotel1, hotel2) {
  let reviews;
...
app.get('/hotels/sort/reviews', (req, res) => {
  let hotelsCopy = hotels.slice();
  let result = hotelsCopy.sort(sortReview);
  res.json({ hotels: result });
});
